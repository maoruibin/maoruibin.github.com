...
自己也是一个 RSS 爱好者，但是在 Android 平台上一种没找到让自己满意的订阅软件，所以最近开发了一个 Android 订阅软件 -上面的 gif 示例图就是 App 的使用示例，如果对此有兴趣，欢迎[下载体验](http://fir.gudong.site/gulz)，如果你对这个订阅软件有任何想法建议，也非常愿意看到的留言或者私信。
